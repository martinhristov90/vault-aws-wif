...
# Based on https://github.com/hashicorp/hc-sec-demos/pull/34/files#diff-fe24fc65b9306e18ca46c3f4750ac85f30e507d2b9d4fb812844818e251989ab

#
# API Gateway
#
#Only two endpoints need to be exposed from Vault to the public, "openid-configuration" and "keys".
#The API Gataway is used to expose those two endpoints to the public, which are utilized by AWS IAM and assuming roles. 
